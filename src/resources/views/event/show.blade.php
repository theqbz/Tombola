...
@section('content')
    ...
    <div class="container-lg">
        ...
        <div class="row align-items-top mb-2">
            ...
            <div class="col-lg-3 pt-3">
                ...
                <div class="d-grid gap-2 d-xs-flex justify-content-sm-end">
                    ...
                    @if($event->isAvailable() && $event->hasMoreTickets() && ($event->is_public))
                        @if((!(Auth::user()->isEditor($event->id)) && (!Auth::user()->hasTicketForEvent($event))))
                            @php
                            ...
                            @endphp
                            {{Form::model($event, array('route' => array($route, ['id'=>$event->id]),'enctype'=>"multipart/form-data"))}}
        ...
        <div class="row border-top border-light align-items-top p-3">
            ...
            @if($event->isAvailable() && $event->hasMoreTickets() && ($event->is_public) && $event->hasLimit())
