...
@section('content')
    ...
    <div class="container-lg">
        ...
        <p class="lead text-dark">Üdvözlünk a Ticketto rendszerében!</p>
    </div>
    ...
    <div class="container-lg">
        <div class="row">
            ...
            <div id="tickets" class="col-sm-12 col-md-4 p-3 border-end">
            ...
            <div id="events" class="col-sm-12 col-md-4 p-3 border-end">
                <p class="h2 p-1 text-dark fw-bold">Játékok</p>
                @php
                    $events = array();
            ...
            <div id="prizes" class="col-sm-12 col-md-4 p-3">
                <p class="h2 p-1 text-dark fw-bold">Nyereményeim</p>
