...
<body class="d-flex flex-column h-100">
    ...
    <main class="flex-shrink-0 pt-4 pb-4">
        <div class="container-lg">
            <p class="small bg-ticketto text-dark p-1"><b>Jelenleg ideiglenes felhasználói státuszban vagy.</b> Játszani így is tudsz, de az oldal minden funkciójának eléréséhez regisztrálnod kell.<br>
            Tombolát az alábbi QR-kóddal vagy profil azonosítóval kaphatsz; a csatlakozás játékhoz gombbal regisztrálhatsz a meghirdetett játékokra.</p>
            <p class="display-3 text-dark">{{$user->email}}</p>
            <div class="row">
                <div class="col-md-3">
                    @include('user.left')
                    <div class="d-grid gap-2 mt-3">
                        <a class="btn btn-primary justify-content-center" href="{{route('connect')}}">Csatlakozás játékhoz</a>
                    </div>
                </div>
                <div class="col-md-9">
